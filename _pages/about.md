...
profile:
  align: right
  image: Profile_Picture_Shravani.png
  image_circular: true # crops the image to make it circular
  # more_info: 
  #  >
  #  <div class="profile-info" style="text-align: center;">
  #    <p class="profile-name" style="font-family: 'Arial'; display: block;">N Shravani</p>
  #    <p class="profile-department">nakidi.shravani@pilani.bits-pilani.ac.in</p>
  #  </div>
